...
{
	case None = 0, Hamburger, Funnel, BackArrow, Add, Save, Share, ClearAll, Expand, Detail
	
	public static let imageNames = ["", "nav_icon", "filter_icon", "back_arrow", "playlist_add_icon", "", "share_icon", "", "nav_expand", "nav_detail_icon"]
